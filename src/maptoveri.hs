...
--
--
cmpFstStr (a,b) (c,d) | a < c = LT
cmpFstStr (a,b) (c,d) | a == c = EQ
cmpFstStr (a,b) (c,d) | otherwise = GT
--
--
--
showAMod::Mod->String
showAMod (mn,inum,ilist,olist) = (showModName mn inum) ++ showInList (sortBy (cmpFstStr) ilist) ++ showOutList (allButLast (sortBy (cmpFstStr) olist)) ++ showOutListNC ( lastOne (sortBy (cmpFstStr) olist)) ++ ")" ++ ['\n']
--
--
--
allButLast::[a]->[a]
